...
public class ImageCodeUtils
{
    ...
    public ImageCodeUtils(HttpServletRequest request)
    {
        this.request = request;
    }

    public ImageCodeUtils(int width, int height,int length,HttpServletRequest request) {
        this.width = width;
        this.height = height;
        this.request = request;
        this.length = length;
    ...
    private BufferedImage createImage(){
        if(request==null)
            throw new RuntimeException("图片创建错误没有长宽");
